...
INSERT INTO `etapes` (`ide`, `idc`, `nome`, `photoe`, `descriptione`, `debut`, `fin`, `lieurencontre`) VALUES ('8', '2', 'Lisbonne', 'Lisbonne.jpg', 'Seconde étape du voyage au Portugal', '2022-12-27 18:00:00', '2022-12-28 20:00:00', 'Premiere journee à Lisbonne');
INSERT INTO `etapes` (`ide`, `idc`, `nome`, `photoe`, `descriptione`, `debut`, `fin`, `lieurencontre`) VALUES ('2', '2', 'Porto', 'porto2.jpg', 'Première étape du voyage au Portugal', '2022-12-25 18:00:00', '2022-12-26 20:00:00', 'Premiere journee à Porto');
